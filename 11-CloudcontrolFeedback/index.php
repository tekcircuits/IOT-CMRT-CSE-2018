...
<body>
 <div class="container" style="height:1500px">
        <div  style="padding-top:40px;color:#254970">
         <h4 align="center"><strong>Cloud Control Library for IOT devices</strong></h4>
         </div>
		 <form action="add.php" method="post">
		  <input type="submit" value="Add"  style="float:right"/> 
			 ...
			 $query="SELECT user_id,pt_id ,feedback ,COUNT(feedback) feed_count from feedback where user_id = '1' GROUP BY feedback,pt_id order by pt_id ,feedback desc";
		 ...
		 <div class="form-group" style="padding-top:10px">
			...
			<input type = "hidden" value = "'.$r['id'].'" name = "id">
			  ...
			  ';
				...
				if($feed_arr[$k]['pt_id'] == $i)
				{
					if(!isset($feed_arr[$k]['feed_count']))
						$feed_arr[$k]['feed_count'] = 0;
					if(!isset($feed_arr[$k+1]['feed_count']))
						$feed_arr[$k+1]['feed_count'] = 0;
				  echo '<div class="row">
						  <div class="col-lg-6">					  
						  Successful Attempts: '.$feed_arr[$k]['feed_count'].'&nbsp;&nbsp;&nbsp;
						  Failed Attempts: '.$feed_arr[$k+1]['feed_count'].'&nbsp;&nbsp;&nbsp;
						  Total attempts: '.($feed_arr[$k]['feed_count'] + $feed_arr[$k+1]['feed_count']).'					  
						  </div>';
				}
					  $i++;
					  $k = $k+2;
					  echo '
					  <div class="col-lg-6" style="padding-left:900px">
...
<script>
var switches = <?php print_r(json_encode($sw_arr)); ?>;
